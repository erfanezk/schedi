...
[Taskwave API Documentation](../../../modules.md) / [core/src](../README.md) / IntervalTaskRunner

# Class: IntervalTaskRunner

Defined in: [core/src/runners/interval-runner.ts:30](https://github.com/erfanezk/schedi/blob/master/packages/core/src/runners/interval-runner.ts#L30)
...
- [`BaseRunner`](BaseRunner.md)\<[`IntervalTask`](../interfaces/IntervalTask.md)\>

## Constructors

### Constructor

> **new IntervalTaskRunner**(`tasks`, `config?`): `IntervalTaskRunner`

Defined in: [core/src/runners/interval-runner.ts:38](https://github.com/erfanezk/schedi/blob/master/packages/core/src/runners/interval-runner.ts#L38)
...
[`IntervalTask`](../interfaces/IntervalTask.md)\<`unknown`\>[] = `[]`

Array of interval tasks to manage (default: empty array)

##### config?

[`IntervalTaskRunnerConfig`](../interfaces/IntervalTaskRunnerConfig.md)
...
Defined in: [core/src/runners/interval-runner.ts:48](https://github.com/erfanezk/schedi/blob/master/packages/core/src/runners/interval-runner.ts#L48)
...
> **addTask**\<`T`\>(`data`): [`IntervalTask`](../interfaces/IntervalTask.md)\<`T`\>

Defined in: [core/src/runners/interval-runner.ts:81](https://github.com/erfanezk/schedi/blob/master/packages/core/src/runners/interval-runner.ts#L81)
...
[`IntervalTaskCreatePayload`](../interfaces/IntervalTaskCreatePayload.md)\<`T`\>

The task creation payload

#### Returns

[`IntervalTask`](../interfaces/IntervalTask.md)\<`T`\>

The created interval task
...
> **updateTask**\<`T`\>(`id`, `data`): [`IntervalTask`](../interfaces/IntervalTask.md)\<`T`\> \| `undefined`

Defined in: [core/src/runners/interval-runner.ts:113](https://github.com/erfanezk/schedi/blob/master/packages/core/src/runners/interval-runner.ts#L113)
...
`Partial`\<[`IntervalTaskCreatePayload`](../interfaces/IntervalTaskCreatePayload.md)\<`T`\>\>

Partial task data to merge with the existing task

#### Returns

[`IntervalTask`](../interfaces/IntervalTask.md)\<`T`\> \| `undefined`
...
> **getTask**(`taskId`): [`IntervalTask`](../interfaces/IntervalTask.md)\<`unknown`\> \| `undefined`
...
[`IntervalTask`](../interfaces/IntervalTask.md)\<`unknown`\> \| `undefined`
...
> **getTasks**(): [`IntervalTask`](../interfaces/IntervalTask.md)\<`unknown`\>[]
...
[`IntervalTask`](../interfaces/IntervalTask.md)
